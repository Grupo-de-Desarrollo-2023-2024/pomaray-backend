...
router.register(r'academicQualification',
                academicQualificationView, 'academicQualification')
router.register(r'tecnicQualification',
                tecnicQualificationView, 'tecnicQualification')
...
urlpatterns = [
    ...
    path('docs/student', include_docs_urls(title='Student API')),
